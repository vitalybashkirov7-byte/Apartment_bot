...
class ApartmentBot:
    ...
    async def help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        help_message = (
            ...
            "⚙️ <b>Настройки:</b>\n"
            "• /settings — изменение параметров поиска\n\n"
            "📌 <b>Важно:</b>\n"
            "• При парсинге сайтов возможно появление капчи\n"
            "• Используйте бота ответственно и не создавайте чрезмерную нагрузку\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "⚠️ <i>Проект некоммерческий, создан для личного пользования.\n"
            "Автоматический сбор данных может нарушать ToS сайтов.\n"
            "Используйте на свой страх и риск.\n"
            "Благодарности приветствуются: @BashkirovVitaly</i>"
        )
